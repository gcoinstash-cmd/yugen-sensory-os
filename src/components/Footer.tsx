      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-12 relative z-10 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 border-b border-white/5 pb-12">
          ...
          <div className="md:col-span-4 space-y-4">
            ...
            <p className="font-sans text-xs font-semibold text-neutral-600 uppercase tracking-widest leading-relaxed">
          ...
          <div className="md:col-span-3 space-y-3">
            <h4 className="font-sans text-xs font-semibold tracking-wider uppercase tracking-[0.25em] text-yugen-gold font-semibold">
              The Compound Places
            </h4>
          ...
          <div className="md:col-span-3 space-y-3">
            <h4 className="font-sans text-xs font-semibold tracking-wider uppercase tracking-[0.25em] text-yugen-gold font-semibold font-mono">
              DX Template Hook
            </h4>
            <div className="flex flex-col space-y-2 text-xs font-semibold leading-relaxed font-sans text-neutral-500">
              <p>
          ...
          <div className="md:col-span-2 space-y-3">
            <h4 className="font-sans text-xs font-semibold tracking-wider uppercase tracking-[0.25em] text-neutral-400 font-semibold">
              Sitting Hours
            </h4>
            <div className="flex flex-col space-y-2 text-xs font-sans">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-semibold tracking-wider tracking-wider uppercase font-sans text-neutral-600">
